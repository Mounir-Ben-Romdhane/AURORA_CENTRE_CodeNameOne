...
//    }
 ...
 Button delete = new Button("Supprimer service");
                        Button update = new Button("Editer service");
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        boolean result = ServiceService.getInstance().deleteService((int) id);
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        service.setTitreS((String) dataItem.get("titreS"));
        service.setDescriptionS((String) dataItem.get("descriptionS"));
        service.setTypSe((String) dataItem.get("typeS"));

        new ModifService(current,service, (double) dataItem.get("id"));
    }
            });
            ...
            container.addAll(titreLabel, typeLabel, descriptionLabel,update,delete,tri);
    }
    add(container);
