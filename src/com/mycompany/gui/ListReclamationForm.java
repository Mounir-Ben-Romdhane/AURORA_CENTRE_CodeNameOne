...
public class ListReclamationForm extends Form {
    ...
    for (int i = 0; i < len; i++) {
        ...
        switch (((Double)dataItem.get("status")).intValue()) {
                 case 0:
                     status="en cours";
             ...
             tri.setAlignment(CENTER);
              Button btnSupprimer = new Button("Supprimer ");
               ...
               public void actionPerformed(ActionEvent evt) {
                ...
                if(SessionManager.getEmail().equals(dataItem.get("email_connecte"))){
                System.out.println(SessionManager.getEmail()+dataItem.get("email_connecte"));
